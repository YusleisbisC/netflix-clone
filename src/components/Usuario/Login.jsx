...
export function Login() {
  ...
  const [registrationSuccess, setRegistrationSuccess] = useState(false); // Estado para el mensaje de registro exitoso
  ...
  const handleAuthentication = async (e) => {
    ...
    try {
      if (isRegistering) {
        ...
        setRegistrationSuccess(true); // Muestra el mensaje de registro exitoso
        // Puedes redirigir al usuario a donde desees después del registro
      } else {
  ...
  return (
    <div>
      ...
      <div className="navbar__logo">
       ...
       <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 111 30" aria-hidden="true" role="img">
          <path fill="#E50914" d="M0 0h111v30H0z"></path>
    ...
    <div className="login">
      ...
      <div className="login__container">
        ...
        <form onSubmit={handleAuthentication}>
          ...
          <input
            type="password"
            placeholder="Contraseña (entre 4 y 60 caracteres)"
            value={password}
        ...
        <p className="help-text">
          ¿Necesitas ayuda? <span>Novo por aqui? Assine agora.</span>
        </p>
